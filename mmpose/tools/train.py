...
def parse_args():
    ...
    parser.add_argument('--config', default='../configs/main/simple.py',help='train config file path')
    parser.add_argument('--work-dir', default='../work_dirs/simple/', help='the dir to save logs and models')
    parser.add_argument(
        '--resume',
        nargs='?',
        type=str,
