...
_C.DATASET.NUM_JOINTS = 6
_C.DATASET.NUM_CLASSES = 19
_C.DATASET.TRAIN_SET = 'list/cityscapes/train.lst'
_C.DATASET.EXTRA_TRAIN_SET = ''
_C.DATASET.VALID_SET = 'list/cityscapes/val.lst'
_C.DATASET.TEST_SET = 'list/cityscapes/test.lst'

# training
_C.TRAIN = CN()

_C.TRAIN.TASK = ['keypoint','seg','line']

_C.TRAIN.SEG_EFFI = 1.0
_C.TRAIN.KEYPOINT_EFFI = 1.0
_C.TRAIN.LINE_EFFI = 1.0
_C.TRAIN.SEG_KEYPOINT_EFFI = 1.0
_C.TRAIN.AUTOWEIGHTLOSS = False
...
_C.TRAIN.HEATMAP_SIZE = [130, 130]  # width * height
_C.TRAIN.SIGMA = 1.5  # 热力图

_C.TRAIN.LR_ADJAST = 'exp'
