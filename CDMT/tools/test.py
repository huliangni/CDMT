...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        default='experiments/HipJoint/w18_520_seg_keypoint_line_adam_exp_1916_calib_V0.yaml',
                        type=str)
    ...
    #args.opts.DATASET.TEST_SET = 'test.txt'
...
def main():
    ...
    if 'val' in config.DATASET.TEST_SET:
        ...
        save_dict = testval(config, 
             test_dataset, 
             testloader, 
             model,
             sv_dir=final_output_dir)

    torch.save(save_dict, final_output_dir+'/predictions.pth')
